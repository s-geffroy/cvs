...
Sphère bouddhiste de l'Asie de l'Est et du Sud-Est (Thaïlande, Cambodge, Laos, Myanmar, Mongolie, Corée du Sud — controversée).

## Description longue

Extension de Huntington qui classait le bouddhisme comme civilisation 'non clairement délimitée'. IW: TS modéré, SE proche de zéro. Hofstede divers: PDI moyen-élevé, IDV bas, UAI variable. Inclut Theravada (THA, MMR, LAO, KHM) et Mahayana (KOR, MNG, certaines régions vietnamiennes).

## Cartographie académique

| Repère | Valeur |
|---|---|
| Étiquette Huntington | `Buddhist (not clearly delineated)` |
| Clusters Inglehart-Welzel | Southeast Asia |
| Quadrant IW | `TS≈0 / SE≈0` |
| Hofstede archétypes | THA, KOR, MMR, MNG |
...
- **`μ_viz`** (Inglehart-Welzel : TS, SE) = `[-0.30, -0.17]`
- **`μ_score`** (Hofstede PDI, IDV, MAS, UAI, LTO, IVR) =
  `[79.0, 20.3, 44.0, 72.0, 42.8, 44.8]`
