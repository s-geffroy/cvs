...
!!! danger "Restrictions de représentation"
    ...
    - Frontières issues de **Natural Earth 110m** (domaine public), simplification globale —
      certains États (HKG, SGP) sont absents à cette résolution.
    - La couleur d'un État reflète sa **civilisation dominante par affinité** dans
      `B_score`, et **ne représente pas une identité** des populations.
...
- **Couches** : choropleth par civilisation dominante (affinité argmax).
- **Source géométries** : `ne_110m_admin_0_countries` @ commit `ca96624a56bd078437bca8184e78163e5039ad19`.
