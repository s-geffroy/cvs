# Bhoutan (`BTN`) — profil civilisationnel
...
- **Téléchargement** : [`BTN.geojson`](../assets/data/states/BTN.geojson)
- **Provenance** : `geometry_source = "Natural Earth"` · `contains_gadm_geometry = false`.


## Téléchargements

- [Profil JSON brut (`BTN.profile.json`)](../assets/data/states/BTN.profile.json)

- [Géométrie (`BTN.geojson`)](../assets/data/states/BTN.geojson)
