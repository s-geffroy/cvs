# Ghana (`GHA`) — profil civilisationnel
...
## Second moment civilisationnel `M(GHA)`
...
|---|---|---|
| `I1 = tr(M)` | `2731.77` | Magnitude totale du second moment |
| `I2` (von Mises) | `2192.54` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
