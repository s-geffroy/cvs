...
## Second moment civilisationnel `M(PAK)`
...
|---|---|---|
| `I1 = tr(M)` | `3387.58` | Magnitude totale du second moment |
| `I2` (von Mises) | `2348.47` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `4.33e+14` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `1199.32` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `2188.26` | Écart de l'État à son barycentre d'affinité |
