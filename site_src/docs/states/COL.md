# Colombie (`COL`) — profil civilisationnel
...
## Second moment civilisationnel `M(COL)`
...
|---|---|---|
| `I1 = tr(M)` | `2471.07` | Magnitude totale du second moment |
| `I2` (von Mises) | `2048.23` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `2.58e+12` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `803.35` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `1667.73` | Écart de l'État à son barycentre d'affinité |
