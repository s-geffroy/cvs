# État `SRB` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(SRB)`
...
|---|---|---|
| `I1 = tr(T)` | `1421.31` | Tension totale |
| `I2` (déviatorique) | `522202.61` | Asymétrie |
| `det(T)` | `1.21e+12` | Rigidité |
