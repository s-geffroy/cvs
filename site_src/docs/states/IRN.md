# État `IRN` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(IRN)`
...
|---|---|---|
| `I1 = tr(T)` | `2070.07` | Tension totale |
| `I2` (déviatorique) | `933436.18` | Asymétrie |
| `det(T)` | `1.35e+13` | Rigidité |
