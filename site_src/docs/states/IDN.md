# État `IDN` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(IDN)`
...
|---|---|---|
| `I1 = tr(T)` | `1574.68` | Tension totale |
| `I2` (déviatorique) | `466381.50` | Asymétrie |
| `det(T)` | `3.69e+12` | Rigidité |
