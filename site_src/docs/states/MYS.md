# État `MYS` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(MYS)`
...
|---|---|---|
| `I1 = tr(T)` | `2531.42` | Tension totale |
| `I2` (déviatorique) | `1754798.65` | Asymétrie |
| `det(T)` | `4.54e+13` | Rigidité |
