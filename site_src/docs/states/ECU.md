# État `ECU` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(ECU)`
...
|---|---|---|
| `I1 = tr(T)` | `1435.56` | Tension totale |
| `I2` (déviatorique) | `267417.72` | Asymétrie |
| `det(T)` | `4.39e+12` | Rigidité |
