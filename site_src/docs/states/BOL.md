# État `BOL` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(BOL)`
...
|---|---|---|
| `I1 = tr(T)` | `1130.52` | Tension totale |
| `I2` (déviatorique) | `266894.79` | Asymétrie |
| `det(T)` | `4.19e+11` | Rigidité |
