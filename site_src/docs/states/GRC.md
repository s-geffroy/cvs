# État `GRC` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(GRC)`
...
|---|---|---|
| `I1 = tr(T)` | `2872.50` | Tension totale |
| `I2` (déviatorique) | `2240763.11` | Asymétrie |
| `det(T)` | `4.64e+13` | Rigidité |
