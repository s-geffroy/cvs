# État `MNG` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(MNG)`
...
|---|---|---|
| `I1 = tr(T)` | `1558.60` | Tension totale |
| `I2` (déviatorique) | `553362.79` | Asymétrie |
| `det(T)` | `5.36e+12` | Rigidité |
