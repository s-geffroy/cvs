# Espagne (`ESP`) — profil civilisationnel
...
## Second moment civilisationnel `M(ESP)`
...
|---|---|---|
| `I1 = tr(M)` | `2246.28` | Magnitude totale du second moment |
| `I2` (von Mises) | `1102.46` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `3.27e+13` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `1375.29` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `870.99` | Écart de l'État à son barycentre d'affinité |
