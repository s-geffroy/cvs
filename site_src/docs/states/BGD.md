# Bangladesh (`BGD`) — profil civilisationnel
...
## Second moment civilisationnel `M(BGD)`
...
|---|---|---|
| `I1 = tr(M)` | `1546.76` | Magnitude totale du second moment |
| `I2` (von Mises) | `732.04` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `9.76e+12` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `995.51` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `551.25` | Écart de l'État à son barycentre d'affinité |
