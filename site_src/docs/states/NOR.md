# État `NOR` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(NOR)`
...
|---|---|---|
| `I1 = tr(T)` | `3754.29` | Tension totale |
| `I2` (déviatorique) | `6597241.07` | Asymétrie |
| `det(T)` | `1.48e+13` | Rigidité |
