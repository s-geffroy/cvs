# Myanmar (`MMR`) — profil civilisationnel
...
`x_viz = observed` ·
`x_score = observed_with_dim_imputation` · centroïde de repli : `buddhist`.
...
## Second moment civilisationnel `M(MMR)`
...
|---|---|---|
| `I1 = tr(M)` | `1126.28` | Magnitude totale du second moment |
| `I2` (von Mises) | `415.50` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `3.37e+12` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `938.37` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `187.91` | Écart de l'État à son barycentre d'affinité |
