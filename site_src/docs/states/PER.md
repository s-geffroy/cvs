# Pérou (`PER`) — profil civilisationnel
...
## Second moment civilisationnel `M(PER)`
...
|---|---|---|
| `I1 = tr(M)` | `1602.53` | Magnitude totale du second moment |
| `I2` (von Mises) | `899.53` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `9.45e+12` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `847.23` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `755.30` | Écart de l'État à son barycentre d'affinité |
