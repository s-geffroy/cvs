# État `FRA` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(FRA)`
...
|---|---|---|
| `I1 = tr(T)` | `3400.25` | Tension totale |
| `I2` (déviatorique) | `2745969.47` | Asymétrie |
| `det(T)` | `3.36e+14` | Rigidité |
