# Chine (`CHN`) — profil civilisationnel
...
## Second moment civilisationnel `M(CHN)`
...
|---|---|---|
| `I1 = tr(M)` | `2579.19` | Magnitude totale du second moment |
| `I2` (von Mises) | `1991.75` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `9.34e+12` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `1091.10` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `1488.08` | Écart de l'État à son barycentre d'affinité |
