# État `EGY` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(EGY)`
...
|---|---|---|
| `I1 = tr(T)` | `3833.05` | Tension totale |
| `I2` (déviatorique) | `7026633.24` | Asymétrie |
| `det(T)` | `3.76e+13` | Rigidité |
