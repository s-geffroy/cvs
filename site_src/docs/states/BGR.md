# État `BGR` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(BGR)`
...
|---|---|---|
| `I1 = tr(T)` | `1946.96` | Tension totale |
| `I2` (déviatorique) | `924324.13` | Asymétrie |
| `det(T)` | `3.07e+13` | Rigidité |
