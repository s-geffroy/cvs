# Turquie (`TUR`) — profil civilisationnel
...
## Second moment civilisationnel `M(TUR)`
...
|---|---|---|
| `I1 = tr(M)` | `1439.98` | Magnitude totale du second moment |
| `I2` (von Mises) | `564.46` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `5.42e+12` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `1082.37` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `357.61` | Écart de l'État à son barycentre d'affinité |
