# État `ZWE` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(ZWE)`
...
|---|---|---|
| `I1 = tr(T)` | `1302.57` | Tension totale |
| `I2` (déviatorique) | `147194.88` | Asymétrie |
| `det(T)` | `7.00e+12` | Rigidité |
