# État `THA` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(THA)`
...
|---|---|---|
| `I1 = tr(T)` | `1407.36` | Tension totale |
| `I2` (déviatorique) | `209082.37` | Asymétrie |
| `det(T)` | `9.17e+12` | Rigidité |
