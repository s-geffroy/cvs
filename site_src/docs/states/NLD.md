# État `NLD` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(NLD)`
...
|---|---|---|
| `I1 = tr(T)` | `3893.90` | Tension totale |
| `I2` (déviatorique) | `7228253.27` | Asymétrie |
| `det(T)` | `2.25e+13` | Rigidité |
