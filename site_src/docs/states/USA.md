# États-Unis (`USA`) — profil civilisationnel
...
## Second moment civilisationnel `M(USA)`
...
|---|---|---|
| `I1 = tr(M)` | `3231.62` | Magnitude totale du second moment |
| `I2` (von Mises) | `2801.00` | √(3/2 · s:s) avec `s = M − tr(M)/6 · I` |
| `det(M)` | `6.63e+12` | Déterminant |
...
|---|---|---|
| Dispersion intra (Cov_w) | `1053.73` | Étalement pondéré des centroïdes autour de μ̄ |
| Biais (μ̄ − xₛ)(μ̄ − xₛ)ᵀ | `2177.89` | Écart de l'État à son barycentre d'affinité |
