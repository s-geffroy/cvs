# État `VEN` — profil civilisationnel
...
## Tenseur de tension civilisationnelle `T(VEN)`
...
|---|---|---|
| `I1 = tr(T)` | `3999.78` | Tension totale |
| `I2` (déviatorique) | `8849652.37` | Asymétrie |
| `det(T)` | `6.23e+12` | Rigidité |
